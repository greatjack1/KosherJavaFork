...
public class AstronomicalCalendar implements Cloneable {
     ...
     */
    public LocalDateTime getSeaLevelSunrise() {
     ...
     * @see #CIVIL_ZENITH
     */
    public LocalDateTime getBeginCivilTwilight() {
     ...
     * @see #NAUTICAL_ZENITH
     */
    public LocalDateTime getBeginNauticalTwilight() {
     ...
     */
    public LocalDateTime getBeginAstronomicalTwilight() {
     ...
     */
    public LocalDateTime getSeaLevelSunset() {
     ...
     * @see #CIVIL_ZENITH
     */
    public LocalDateTime getEndCivilTwilight() {
     ...
     * @see #NAUTICAL_ZENITH
     */
    public LocalDateTime getEndNauticalTwilight() {
     ...
     * @see #ASTRONOMICAL_ZENITH
     */
    public LocalDateTime getEndAstronomicalTwilight() {
     ...
     */
    public LocalDateTime getTimeOffset(LocalDateTime time, double offset) {
     ...
     */
    public LocalDateTime getTimeOffset(LocalDateTime time, long offset) {
        if (time == null || offset == Long.MIN_VALUE) {
            return null;
        }
        return dateToLocalDateTime(new Date(localDateTimeToDate(time).getTime() + offset));
    }
     ...
     *
     * @param offsetZenith the degrees before {@link #getSunrise()} to use in the calculation. For time after sunrise use
     ...
     * page.
     */
    public LocalDateTime getSunriseOffsetByDegrees(double offsetZenith) {
     ...
     * page.
     */
    public LocalDateTime getSunsetOffsetByDegrees(double offsetZenith) {
     ...
     * @see #getTemporalHour()
     */
    public long getTemporalHour(LocalDateTime startOfday, LocalDateTime endOfDay) {
        if (startOfday == null || endOfDay == null) {
            return Long.MIN_VALUE;
        }
        return (localDateTimeToDate(endOfDay).getTime() - localDateTimeToDate(startOfday).getTime()) / 12;
    }
     ...
     * @see #getTemporalHour()
     */
    public LocalDateTime getSunTransit() {
     ...
     * @return the <code>LocalDateTime</code> representing Sun's transit. If the calculation can't be computed such as in the
     * Arctic Circle where there is at least one day a year where the sun does not rise, and one where it does
     * not set, null will be returned. See detailed explanation on top of the page.
     */
    public LocalDateTime getSunTransit(LocalDateTime startOfDay, LocalDateTime endOfDay) {
     ...
     *
     * @param time      The time to be set as the time for the <code>Date</code>. The time expected is in the format: 18.75
     *                  for 6:45:00 PM.time is sunrise and false if it is sunset
     * @param isSunrise true if the
     * @return The Date.
     */
    protected LocalDateTime getDateFromTime(double time, boolean isSunrise) {
